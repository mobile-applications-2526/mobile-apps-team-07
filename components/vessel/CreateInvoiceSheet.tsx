        ...
        try {
            ...
            if (invoiceType === 'TC') {
                ...
                const payload = {
                    ...
                    cargoQuantityMt: parseFloat(cargoQuantity) || 0,
                    freightAmount: freightAmount,
                    demurrageAmount: demurrageType === 'Demurrage' ? demurrageAmount : 0,
                    despatchAmount: demurrageType === 'Despatch' ? demurrageAmount : 0,
                    portCharges: parseFloat(portCharges) || 0,
                    charges: [
